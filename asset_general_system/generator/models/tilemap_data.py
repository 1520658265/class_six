...
from ..config import DEFAULT_TILE_SIZE, TILES, VERSION
...
class ObjectData(StrictModel):
    ...
    sprite_ref: str | None = None  # External art asset id, if an art pipeline has attached one
    sprite_path: str | None = None  # External sprite image path, if available
